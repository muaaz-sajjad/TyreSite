...
export default function FAQ() {
    ...
    return (
        ...
        .faq__num { font-family: 'Outfit', sans-serif; font-weight: 700; color: var(--gold-primary); font-size: 0.8rem; min-width: 24px; flex-shrink: 0; }
        .faq__q-text { flex: 1; line-height: 1.4; }
        .faq__toggle { font-size: 1.3rem; color: var(--gold-primary); min-width: 20px; text-align: center; flex-shrink: 0; }
        ...
        .faq__item--open .faq__question { color: var(--gold-primary); }
