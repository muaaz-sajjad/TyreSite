...
export default function EmergencyCTA() {
    return (
        <section className="ecta section">
            ...
            <div className="container ecta__inner">
                <div className="ecta__content">
                    ...
                    <p className="ecta__sub">We Are Always Ready <span className="gold-text">24/7</span> for Emergency Tyre Repair &amp; Fitting</p>
        ...
        .ecta__bg { position: absolute; inset: 0; background: linear-gradient(135deg, rgba(201,168,76,0.1), rgba(201,168,76,0.03), rgba(30,30,60,0.2)); border-top: 1px solid var(--border-gold); border-bottom: 1px solid var(--border-gold); }
